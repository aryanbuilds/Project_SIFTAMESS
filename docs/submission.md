...
| 8 | **Agent execution logs (timestamped, finding→tool traceable)** | [`execution_logs_sample.md`](execution_logs_sample.md) (real ROCBA ledger excerpts) | ✅ |
...
- Real-evidence run directories are **not committed** (CLAUDE.md §2B); this `docs/` set is the curated,
  verifiable record, and the maintainer can show the full ledgers live on the workstation.
