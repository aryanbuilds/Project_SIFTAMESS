...
- **A corrupt event log.** `Security.evtx` died in three different NTFS readers at the same spot. For once, not my bug. I made it fail closed and say so instead of faking it.
